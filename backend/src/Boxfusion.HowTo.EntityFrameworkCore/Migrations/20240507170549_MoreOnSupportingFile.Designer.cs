...
namespace Boxfusion.HowTo.Migrations
{
    ...
    [Migration("20240507170549_MoreOnSupportingFile")]
    partial class MoreOnSupportingFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.BankDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.ExecutorCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Guide", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.GuideStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Media", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Offer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<float>("CounterAmount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Payable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.BankDetail", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.ExecutorCategory", b =>
                {
                    ...
                    b.HasOne("Boxfusion.HowTo.Domain.Profile", "Profile")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Guide", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Users.User", "Writer")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.GuideStep", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Domain.Guide", "Guide")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Media", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Domain.GuideStep", "GuideStep")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Message", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Users.User", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Payable", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Domain.BankDetail", "BankDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Payment", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Authorization.Users.User", "Beneficiary")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.HowTo.Domain.Portfolio", b =>
                {
                    b.HasOne("Boxfusion.HowTo.Domain.Profile", "ProfileModel")
                        .WithMany()
