...
{
    /// <inheritdoc />
    public partial class Level4Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuideStepId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medias_GuideSteps_GuideStepId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payables_BankDetails_BankDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medias_GuideStepId",
                table: "Medias",
                column: "GuideStepId");

            migrationBuilder.CreateIndex(
                name: "IX_Payables_BankDetailId",
                table: "Payables",
                column: "BankDetailId");
        }
