...
{
    public abstract class HowToWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HowToWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HowToWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HowToDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HowToDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HowToDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HowToDbContext, Task<T>> func)
        {
            T result;
